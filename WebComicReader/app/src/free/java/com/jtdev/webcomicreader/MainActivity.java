...
import com.jtdev.webcomicreader.ComicActivity;
import com.jtdev.webcomicreader.HelpActivity;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, NetworkBroadcastReceiver.NetworkChangeListener, ZoomableImageCallback
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//TODO Remove test ads for release
		adView = (AdView) this.findViewById(R.id.ad_view);
		adRequest = new AdRequest.Builder()
				.addTestDevice(AdRequest.DEVICE_ID_EMULATOR)
				.addTestDevice("027B2038854532E3BD9020BD5EDED426")
				.build();
	...
	{
		//AdView has issues with custom orientation handling
		AdView previousAd = (AdView) findViewById(R.id.ad_view);
		RelativeLayout.LayoutParams previousLayout = (RelativeLayout.LayoutParams) previousAd.getLayoutParams();
		RelativeLayout parentLayout = (RelativeLayout) previousAd.getParent();
		parentLayout.removeView(previousAd);

		//TODO Should be a nicer way of doing this
		adView.destroy();
		adView = new AdView(this);
		adView.setAdSize(AdSize.SMART_BANNER);
		adView.setAdUnitId(getString(R.string.banner_ad_unit_id));
		adView.setId(R.id.ad_view);
		adView.setLayoutParams(previousLayout);
